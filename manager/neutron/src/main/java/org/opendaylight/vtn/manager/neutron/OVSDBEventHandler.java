...
public class OVSDBEventHandler  {
    ...
    public void nodeAdded(Node node, DataObject resourceAugmentationData ) {
        ...
        try {
            ...
            LOG.info("Exception occured while Bridge Creation", e);
        }
    }
    ...
    public void getSystemProperties(Node node) {
        ...
        try {
            ...
            prop.load(in);
            LOG.info("loaded Integration bridge Configuartion details from vtn.ini");
        } catch (Exception e) {
            LOG.info("Exception occured while reading SystemProperties", e);
        } finally {
            if (in != null) {
                try {
                    in.close();
        ...
        LOG.info("System properties values : {},{},{},{}:",
                ...
                if (null != integrationBridgeName) {
                   try {
                       ...
                       LOG.info("Exception occured while Adding Bridge", e);
                       }
                 }
    }
