...
public final class OvsdbNodeChange {
    ...
    public static OvsdbNodeChange nodeCreated(
        ...
        @Nonnull Node node) {
        OvsdbNodeChange ovchg = new OvsdbNodeChange(ovh, txh, node);
    ...
    public static OvsdbNodeChange nodeUpdated(
        ...
        @Nonnull Node after) {
        OvsdbNodeChange ovchg = new OvsdbNodeChange(ovh, txh, after);
    ...
    public static OvsdbNodeChange nodeRemoved(
        ...
        if (getOfNode(ovh, node) != null) {
            // Remove all port mappings in the target node.
            ovchg.setUnmapPorts(node);
        }
    ...
    public void apply() {
        ...
        if (removedNode != null) {
            eventHandler.nodeRemoved(removedNode);
        }
    }
     ...
     *               OpenFlow switch.
     */
    private void setMapPorts(@Nonnull Node node, @Nonnull OfNode onode) {
        openflowNode = onode;
        setMapPorts(node);
    }
     ...
     */
    private void setMapPort(@Nonnull OvsdbTerminationPointAugmentation ovtp) {
