...
@PrepareForTest({ OvsdbDataChangeListener.class, VTNManagerService.class, MdsalUtils.class, InstanceIdentifier.class, OfNode.class, OVSDBEventHandler.class})
public class OvsdbDataChangeListenerTest {
    ...
    public void setUp() throws Exception {
        ...
        ovsdbDataChangeListener = PowerMockito.spy(new OvsdbDataChangeListener(dataBroker, mdUtils, vtnManagerService));
        asyncDataChangeEventMockObj = PowerMockito.mock(AsyncDataChangeEvent.class);
        ...
        handler = PowerMockito.spy(new OVSDBEventHandler(mdUtils, vtnManagerService));
        when(dataBroker.registerDataChangeListener(
                  any(LogicalDatastoreType.class), any(InstanceIdentifier.class),
                  isA(OvsdbDataChangeListener.class), any(DataChangeScope.class))).
    ...
    public void testConstructor() {
        ...
        ovsdbDataChangeListener = new OvsdbDataChangeListener(dataBroker, mdUtils, vtnManagerService);
        // Ensure that NeutronNetworkChangeListener has been registered as data change
        // listener.
        when(dataBroker.registerDataChangeListener(
                eq(oper), eq(getPath()), eq(ovsdbDataChangeListener), eq(scope))).thenReturn(listenerReg);
