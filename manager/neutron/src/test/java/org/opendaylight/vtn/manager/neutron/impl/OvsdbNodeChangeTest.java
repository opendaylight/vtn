...
public class OvsdbNodeChangeTest extends TestBase {
    ...
    public void testNodeCreated2() {
        ...
        OfNode onode = new OfNode(0x0000111122223333L);
        ...
        Node node = new NodeBuilder().
            setNodeId(new NodeId("ovsdb:node:created2")).
    ...
    public void testNodeCreated3() {
        ...
        OvsdbNodeAugmentation ovnode = new OvsdbNodeAugmentationBuilder().
            build();
        List<TerminationPoint> tps = Collections.<TerminationPoint>emptyList();
        Node node = new NodeBuilder().
    ...
    public void testNodeRemoved2() {
        ...
        Node node = new NodeBuilder().
            setNodeId(new NodeId("ovsdb:node:removed2")).
            setTerminationPoint(tps).
            addAugmentation(OvsdbBridgeAugmentation.class, ovbr).
            build();
        OvsdbNodeChange ovchg =
    ...
    public void testNodeRemoved5() {
        ...
        Node node = new NodeBuilder().
            setNodeId(new NodeId("ovsdb:node:removed5")).
            setTerminationPoint(tps).
            addAugmentation(OvsdbBridgeAugmentation.class, ovbr).
            build();
        OvsdbNodeChange ovchg =
     ...
     *     modification.
     *   </li>
     *   <li>No OVSDB bridge augmentation.</li>
     * </ul>
     */
    @Test
    public void testNodeUpdated1() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:updated1");
    ...
    public void testNodeUpdated2() {
        ...
        OvsdbNodeAugmentation ovnode = new OvsdbNodeAugmentationBuilder().
            build();
        List<TerminationPoint> tps = Collections.<TerminationPoint>emptyList();
        NodeId nodeId = new NodeId("ovsdb:node:updated2");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            setTerminationPoint(tps).
            addAugmentation(OvsdbBridgeAugmentation.class, ovbr).
     ...
     *   <li>OVSDB node augmentation has been created.</li>
     *   <li>
     *     OVSDB bridge augmentation that contains DPID has been created.
     *   </li>
     * </ul>
     */
    @Test
    public void testNodeUpdated3() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:updated3");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            setTerminationPoint(tps).
            build();
    ...
    public void testNodeUpdated4() {
        ...
        OvsdbNodeAugmentation ovnode = new OvsdbNodeAugmentationBuilder().
            build();
        NodeId nodeId = new NodeId("ovsdb:node:update4");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            addAugmentation(OvsdbNodeAugmentation.class, ovnode).
            addAugmentation(OvsdbBridgeAugmentation.class, ovbr).
     ...
     *     modification.
     *   </li>
     *   <li>Termination points are not changed.</li>
     * </ul>
     */
    @Test
    public void testNodeUpdated5() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:update5");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            setTerminationPoint(tps).
            addAugmentation(OvsdbNodeAugmentation.class, ovnode).
    ...
    public void testNodeUpdated6() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:update6");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            setTerminationPoint(tps).
            build();
    ...
    public void testNodeUpdated7() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:update7");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            setTerminationPoint(tps).
            addAugmentation(OvsdbBridgeAugmentation.class, ovbr).
        ...
        // All the port mappings in the node should be removed because DPID
        // is deleted.
        for (PortAttr pa: pattrs.values()) {
            pa.checkUnmapped();
        }
    ...
    public void testNodeUpdated8() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:update8");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            setTerminationPoint(tps).
    ...
    public void testNodeUpdated9() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:update9");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
    ...
    public void testNodeUpdated10() {
        ...
        NodeId nodeId = new NodeId("ovsdb:node:update10");
        Node before = new NodeBuilder().
            setNodeId(nodeId).
            setTerminationPoint(tps).
            addAugmentation(OvsdbNodeAugmentation.class, ovnode).
