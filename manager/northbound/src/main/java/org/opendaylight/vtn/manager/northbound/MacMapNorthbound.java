...
public class MacMapNorthbound extends VTNNorthBoundBase {
     ...
     *   <ul>
     *     <li>
     *       If <strong>add</strong> is specified to <u>action</u>
     *       parameter, host information configured in
     *       <strong>macmapconf</strong> will be added to MAC mapping
     *       configuration.
     *       <ul>
     *         <li>
     ...
     *     </li>
     *     <li>
     *       If <strong>remove</strong> is specified to <u>action</u>
     *       parameter, host information configured in
     *       <strong>macmapconf</strong> will be removed from MAC mapping
     *       configuration.
     *       <ul>
     *         <li>
     *           Host information in <strong>allow</strong> element will be
     ...
     *   <ul>
     *     <li>
     *       If <strong>add</strong> is specified to <u>action</u> paramer,
     ...
     *     </li>
     *     <li>
     *       If <strong>remove</strong> is specified to <u>action</u> paramer,
     *       host information configured in <strong>machosts</strong> will be
     ...
     *   <u>{macAddr}</u> and <u>{vlan}</u> parameters is already configured
     *   in the Map Allow list.
     * </p>
     *
     * @param uriInfo        Requested URI information.
     * @param containerName  The name of the container.
     ...
     *   <li>
     *     Map Allow list is not modified if the host information specified by
     *     <u>{macAddr}</u> and <u>{vlan}</u> parameters is not configured
     *     in the Map Allow list.
     *   </li>
     *   <li>
     *     MAC mapping is removed if both Map Allow list and Map Deny list
