...
import org.opendaylight.controller.sal.utils.NodeCreator;
  ...
  /**
   * JUnit test for {@link DataFlowListList}.
   */
public class DataFlowListTest extends TestBase {
  ...
  @Test
    public void testGetter() {
      ...
      DataFlow succ = new DataFlow(ids, created, idle, hard, inpath, inport, outpath, outport);
      list.add(succ);
  ...
  @Test
    public void testJAXB() {
      ...
      PortLocation inport = new PortLocation(nc, name);
      PortLocation outport = new PortLocation(nc, name);
      DataFlow dataFlow = new DataFlow(ids, created, idle, hard, inpath, inport, outpath, outport);
      list.add(dataFlow);
