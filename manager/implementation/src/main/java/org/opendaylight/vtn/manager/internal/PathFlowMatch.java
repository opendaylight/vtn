...
/**
 * {@link VTNFlowMatch} implementation which accepts VTN flows which depend
 * on the specified virtual node path.
 */
public class PathFlowMatch implements VTNFlowMatch {
    /**
     ...
     */
    public PathFlowMatch(VTenantPath path) {
        nodePath = path;
    }
