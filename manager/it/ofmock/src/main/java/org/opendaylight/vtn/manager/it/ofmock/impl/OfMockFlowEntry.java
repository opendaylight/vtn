...
public final class OfMockFlowEntry implements OfMockFlow {
    ...
    /**
     * The MD-SAL flow ID associated with this instance.
     */
    ...
    /**
     * Return the MD-SAL flow ID associated with this instance.
     *
     * @return  The MD-SAL flow ID if configured.
    ...
    /**
     * Associatethe given MD-SAL flow ID with this instance.
     *
