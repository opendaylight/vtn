...
##
## Common rules to build mgmt libraries.
##

# Determine the name of plugin module.
#SHLIB_NAME	:= clplug_$(notdir $(CURDIR))

# Use plugin module name as log identifier.
#USE_LOG_IDENT	:= $(SHLIB_NAME)
