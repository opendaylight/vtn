...
namespace ODL.VSEMProvider.Cmdlets {
    ...
    /// about the uplink port profile(s) that are managed by this Extension Manager. 
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "Odl.VSEMUplinkPortProfile")]
    [OutputType(typeof(List<VSEMUplinkPortProfile>))]
    [ManagedName("Microsoft.SystemCenter.NetworkService.GetVSEMUplinkPortProfile")]
    public sealed class GetVSEMUplinkPortProfile : VSEMODLCmdletBase {
        /// <summary>
        /// Id of uplink port profile that is managed by this Extension Manager. 
        /// </summary>
        private Guid iD;
