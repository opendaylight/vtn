...
/**
 * VTerminalInterfaceNorthbound - Bean Representaion for VTerminal Interface object from the JSON Response.
 *
 */
@JsonObject
public class VTerminalInterfaceNorthbound {
     ...
     * Default Constructor.
     */
    public VTerminalInterfaceNorthbound() {
    }
