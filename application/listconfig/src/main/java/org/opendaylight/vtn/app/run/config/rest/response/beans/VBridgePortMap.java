...
/**
 *VBridgePortMap - bean which helps to map the response as java object.
 */
@RestURL(vtnMgrUrl = "controller/nb/v2/vtn/ {containerName}/vtns/ {tenantName}/vbridges/ {bridgeName}/interfaces/ {ifName}/portmap")
@JsonObject
public class VBridgePortMap implements Cloneable, Serializable {
