...
public class Parser {
    ...
    public Object parseJsonObject(Object obj , JSONObject json) throws InstantiationException, IllegalAccessException {
                ...
                for (Field field : obj.getClass().getDeclaredFields()) {
                    ...
                    if (jsonElement != null) {
                        ...
                        if (json.has(jsonList.name())) {
                            ...
                            System.out.println("\r" + field.getGenericType());
                            System.out.println("\r" + (ParameterizedType)field.getGenericType());
                            System.out.println("\r" + ((ParameterizedType)field.getGenericType()).getActualTypeArguments()[0]);
        ...
        System.out.println("\rPARSER OUT:" + obj);
        LOG.trace("JsonObject parser is done");
        return obj;
    }
