...
public class ExtendedCRUDImpl extends CRUDImpl {
     ...
     */
    public ExtendedCRUDImpl(APPLICATION_TYPE appType, String userName,
            String password) {
    ...
    public String doPOST(String url, Object obj, Map<String, Object> headers) throws VTNClientException, ConnectException, JSONException {
        ...
        try {
            ClientResponse response = getWebResource(url, null, headers).type(APPLICATION_TYPE.JSON.getType()).post(ClientResponse.class, obj.toString());
            ...
            if (response.getStatus() == HTTP_RESPONSE.NO_CONTENT.getStatus()) {
                ...
                } else if (response.getStatus() != HTTP_RESPONSE.CREATED.getStatus()) {
    ...
    public String doPUT(String url, Object obj, Map<String, Object> headers) throws VTNClientException, ConnectException, JSONException {
        ...
        try {
            ClientResponse response = getWebResource(url, null, headers).type(APPLICATION_TYPE.JSON.getType()).put(ClientResponse.class, obj.toString());
    ...
    public String doDELETE(String url, Object obj, Map<String, Object> headers) throws VTNClientException, ConnectException, JSONException {
        ...
        try {
            ClientResponse response = getWebResource(url, null, headers).type(APPLICATION_TYPE.JSON.getType()).delete(ClientResponse.class);
