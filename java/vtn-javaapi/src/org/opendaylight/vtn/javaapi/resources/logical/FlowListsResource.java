...
/**
 * The Class FlowListsResource implements post and get methods
 * */
@UNCVtnService(path = "/flowlists")
public class FlowListsResource extends AbstractResource {
	 ...
	 */
	public FlowListsResource() {
		super();
		LOG.trace("Start FlowListsResource#FlowListsResource()");
	...
	public int post(final JsonObject requestBody) throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_FLOWLIST_CREATE, requestBody,
					getNullListObject());
	...
	private List<String> getUriParameters(JsonObject requestBody) {
		...
		LOG.trace("Completed FlowListsRsesource#getUriParameters()");
