...
/**
 * The Class VBridgeInterfaceFlowFilterResource implements delete and get
 * methods.
 * 
 */
...
public class VBridgeInterfaceFlowFilterResource extends AbstractResource {
	...
	private static final Logger LOG = Logger
			.getLogger(VBridgeInterfaceFlowFilterResource.class.getName());

	/**
	 * Instantiates a new v bridge interface flow filter resource.
	 */
	public VBridgeInterfaceFlowFilterResource() {
		super();
		LOG.trace("Start VBridgeInterfaceFlowFilterResource#VBridgeInterfaceFlowFilterResource()");
		setValidator(new FlowFilterResourceValidator(this));
		LOG.trace("Complete VBridgeInterfaceFlowFilterResource#VBridgeInterfaceFlowFilterResource()");
	}
	...
	/**
	 * Implementation of Delete method of VBridgeInterfaceFlowFilter API
	 * 
	 * 
	 * @return Error code
	...
	public int delete() throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBRIF_FLOWFILTER_DELETE,
		...
		LOG.trace("Complete VBridgeInterfaceFlowFilterResource#delete()");
		return status;
	}

	/**
	 * Implementation of Get method of VBridgeInterfaceFlowFilter API
	 * 
	 * @param requestBody
	...
	public int get(final JsonObject requestBody) throws VtnServiceException {
		...
		try {
			...
			requestProcessor = new IpcRequestProcessor(session, getSessionID(),
					getConfigID(), getExceptionHandler());
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBRIF_FLOWFILTER_GET, requestBody,
					getUriParameters());
			LOG.debug("Request packet created successfully");
			status = requestProcessor.processIpcRequest();
			LOG.debug("Request packet processed with status" + status);
		...
		LOG.trace("Complete VBridgeInterfaceFlowFilterResource#get()");
		return status;
	}
	...
	private List<String> getUriParameters() {		
		...
		LOG.trace("Completed VBridgeInterfaceFlowFilterResource#getUriParameters()");
