...
/**
 * The Class BoundaryResource implements put delete and get methods.
 */
@UNCVtnService(path = "/boundaries/{boundary_id}")
public class BoundaryResource extends AbstractResource {
	private static final Logger LOG = Logger.getLogger(BoundaryResource.class
			.getName());
	/** The boundary id. */
	@UNCField("boundary_id")
	...
	/**
	 * Instantiates a new boundary resource.
	 */
	public BoundaryResource() {
		super();
		LOG.trace("Start BoundaryResource#BoundaryResource()");
		setValidator(new BoundaryResourceValidator(this));
		LOG.trace("Complete BoundaryResource#BoundaryResource()");
	}

	/**
	 * Implementation of put method of Boundary API
	 * 
	 * @param requestBody
	...
	public int put(final JsonObject requestBody) throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_BOUNDARY_UPDATE, requestBody,
					getUriParameters());
		...
		LOG.trace("Completed BoundaryResource#put()");
		return status;
	}

	/**
	 * Implementation of delete method of Boundary API
	 * 
	 * @return Error code
	 * @throws VtnServiceException
	 */
	...
	public int delete() throws VtnServiceException {
		...
		try {
			...
			requestProcessor = new IpcRequestProcessor(session, getSessionID(),
					getConfigID(), getExceptionHandler());
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_BOUNDARY_DELETE,
		...
		LOG.trace("Completed BoundaryResource#delete()");
		return status;
	}
	...
	public int get(final JsonObject requestBody) throws VtnServiceException {
		...
		LOG.trace("Completed BoundaryResource#get()");
		return status;
	}
	...
	private List<String> getUriParameters() {
		LOG.trace("Starts BoundaryResource#getUriParameters()");
		final List<String> uriParameters = new ArrayList<String>();
		uriParameters.add(boundaryId);
		LOG.trace("Completed BoundaryResource#getUriParameters()");
