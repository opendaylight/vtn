...
/**
 * The Class FlowFiltersResource.
 * 
 * @author NHST
 * @version 1.0
 */
/* This class handles post method */
@UNCVtnService(path = "/vtns/{vtn_name}/flowfilters")
public class FlowFiltersResource extends AbstractResource {
	/** The vtn name. */
	@UNCField("vtn_name")
	 ...
	 */
	public FlowFiltersResource() {
		super();
		LOG.trace("Start FlowFiltersResource#FlowFiltersResource()");
	...
	public int post(final JsonObject requestBody) throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VTN_FLOWFILTER_CREATE, requestBody,
					getUriParameters());
	...
	private List<String> getUriParameters() {
		LOG.trace("Start FlowFiltersResource#getUriParameters()");
		final List<String> uriParameters = new ArrayList<String>();
		uriParameters.add(vtnName);
		LOG.trace("Completed FlowFiltersResource#getUriParameters()");
