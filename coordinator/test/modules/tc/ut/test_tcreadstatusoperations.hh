...
/* class to test TcReadStatusOperations */
class TestTcReadStatusOperations : public TcReadStatusOperations {

 public:
 TestTcReadStatusOperations(TcLock* tc_lock_,
                            pfc::core::ipc::ServerSession* sess_,
                            TcDbHandler* db_handler,
                            TcChannelNameMap& unc_map_)
                   :TcReadStatusOperations(tc_lock_,sess_,db_handler,unc_map_){}
