...
class ServerSession {
 ...
 public:
  ...
  int   addOutput(val_switch&);
  int   addOutput(val_port&);
  int   addOutput(val_link&);
  int   addOutput(val_boundary_st&);
  int   addOutput(key_ctr&);
  int   addOutput(val_ctr&);
  int   addOutput(void);
  int addOutput(key_ctr_domain&);
  int addOutput(val_ctr_domain&);
  int addOutput(key_logical_port);
  int addOutput(val_logical_port_st&);
  int addOutput(key_logical_member_port);
  int addOutput(key_switch&);
  int addOutput(val_switch_st&);
  int addOutput(key_port);
  int addOutput(val_port_st&);
  int addOutput(unc::driver::key_root_t&);
  ...
  int  addOutput(val_port_st_neighbor&);
  int  addOutput(val_path_fault_alarm_t&);
  int  addOutput(val_boundary&);
  int  addOutput(key_boundary);
  int  addOutput(val_link_st);
  int  addOutput(key_link);
  ...
  int   getArgument(int, key_link_t&);
  int   getArgument(int, val_port_st_t&);
  int   getArgument(int, key_port_t&);
  int   getArgument(int, val_link_st_t&);
  int   getArgument(int, val_switch_st_t&);
  int   getArgument(int, key_switch_t&);

  int  getArgument(int, key_logical_member_port_t&);
  int  getArgument(int, val_logical_port_st_t&);
  int  getArgument(int, key_logical_port_t&);
  int  getArgument(int, val_ctr_domain_t&);
  int  getArgument(int, val_boundary_t&);
  int  getArgument(int, key_boundary_t&);
  int  getArgument(int, key_ctr_domain_t&);
  int  getArgument(int, val_ctr_t&);
  int  getArgument(int, key_ctr_t&);
