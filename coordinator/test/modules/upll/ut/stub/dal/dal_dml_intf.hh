...
class DalDmlIntf {
  public:
    ...
    virtual DalResultCode GetSingleRecord(
                    ...
                    const DalBindInfo *ouput_and_matching_attr_info)= 0;
     ...
     */
    virtual DalResultCode GetNextRecord(const DalCursor *cursor)= 0;
    ...
    virtual DalResultCode DeleteRecords(const UpllCfgType cfg_type,
                                const DalTableIndex table_index,
                                const DalBindInfo *matching_attr_info)= 0;
    ...
    virtual DalResultCode CopyEntireRecords(const UpllCfgType dest_cfg_type,
                                    ...
                                    const DalTableIndex table_index,
                                    const DalBindInfo *output_attr_info) = 0;
