...
TcApiCommonRet TcLibModule::TcLibAuditControllerRequest(std::string controller_id) {
	return stub_getMappedResultCode(TcLibModule::AUDIT_CONTROLLER);
}


TcApiCommonRet TcLibModule::TcLibValidateUpdateMsg(uint32_t sessionid, uint32_t configid) {
...
TcApiCommonRet TcLibModule::TcLibWriteKeyValueDataInfo(std::string controller_id,
                                            uint32_t key_type,
                                            pfc_ipcstdef_t key_def,
                                            pfc_ipcstdef_t value_def,
                                            void* key_data,
...
TcCommonRet TcLibModule::ValidateCommitOperSequence(TcMsgOperType oper_type) {
  ...
  TcCommonRet TcLibModule::TcLibModule::ValidateAuditOperSequence(TcMsgOperType oper_type) {
	  return stub_getMappedResultCode(TcLibModule::VALIDATE_AUDIT_OPER);
  }


  TcCommonRet TcLibModule::ValidateUpllUpplCommitSequence(TcMsgOperType oper_type) {
  ...
  TcCommonRet TcLibModule::ValidateUpllUpplAuditSequence(TcMsgOperType oper_type) {
  ...
  TcApiCommonRet TcLibModule::stub_getMappedResultCode(TcLibModule::TCApiCommonRet methodType) {
 ...
 TcCommonRet TcLibModule::stub_getMappedResultCode(TcLibModule::TCCommonRet methodType) {
