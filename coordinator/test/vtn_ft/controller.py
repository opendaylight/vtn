...
def validate_controller_attributes(controller_id,ipaddr="",version="",auditstatus="",
    description="",username="", password="",operstatus="",type="",controller_url=""):
  url= coordinator_url + controller_url
  print url
  print def_header
  r = requests.get(url,headers=def_header)
...
def add_controller(controller_id,type,version,ipaddr="",auditstatus="", description="", username = "", password = "",controller_url=""):
