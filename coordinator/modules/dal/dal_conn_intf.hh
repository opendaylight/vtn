...
class DalConnIntf {
  public:
     ...
     */
    virtual DalResultCode ConnectToDb(const DalConnType conn_type) const = 0;
     ...
     *                            - Valid errorcode otherwise
     */
    virtual DalResultCode DisconnectFromDb() const = 0;
     ...
     *                            - Valid errorcode otherwise
     */
    virtual DalResultCode CommitTransaction() const = 0;
     ...
     *                            - Valid errorcode otherwise
     */
    virtual DalResultCode RollbackTransaction() const = 0;
