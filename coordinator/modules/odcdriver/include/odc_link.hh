...
class OdcLink {
 ...
 private:
   ...
   */
  drv_resp_code_t fill_edge_value_map(json_object *json_obj_node_prop,
   ...
   */
  void notify_physical(unc::driver::oper_type type, key_link_t *key_link,
               val_link_st_t *val_link, val_link_st_t *val_old_link);
   ...
   */
  void update_list(key_link_t *key_link, std::list<std::string> &link_list);
   ...
   * return drv_resp_code_t           - return DRVAPI_RESPONSE_SUCCESS/ DRVAPI_RESPONSE_FAILURE
   */
  drv_resp_code_t parse_link_response(unc::driver::controller *ctr_ptr,
   ...
   *                                   DRVAPI_RESPONSE_FAILURE
   */
  drv_resp_code_t delete_link(unc::driver::controller *ctr,
