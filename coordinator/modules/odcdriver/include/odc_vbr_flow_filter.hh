      ...
      while ( action_iter != entry->action_.end() ) {
        ...
        if ( act_entry->dscp_ ) {
          if ( act_entry->dscp_->dscp_ != -1 ) {
            ...
            pfc_log_error(" Printing dcsp %d %d" , val_entry.valid[UPLL_IDX_DSCP_FFE], val_entry.dscp);
          }
          ...
          if ( act_entry->vlanpcp_->priority_ != -1 ) {
            ...
            pfc_log_error(" Printing vlanpcp %d %d" , val_entry.valid[UPLL_IDX_PRIORITY_FFE], val_entry.priority);  
          }
