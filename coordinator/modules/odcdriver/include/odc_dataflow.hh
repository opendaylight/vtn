...
#ifndef _ODC_DATAFLOW_HH_
#define _ODC_DATAFLOW_HH_
...
class OdcDataFlowCommand: public unc::driver::vtn_driver_read_command {
 public:
  /**
   * @brief Parametrised Constructor
   * @param[in] - conf file values
   */
  explicit OdcDataFlowCommand(unc::restjson::ConfFileValues_t conf_values);
