...
class OdcSwitch {
 ...
 private:
   ...
   */
  void notify_physical(unc::driver::oper_type type, key_switch_t *key_switch,
               val_switch_st_t *val_switch, val_switch_st_t *val_old_switch);
   ...
   */
  void update_list(key_switch_t *key_switch, std::list<std::string> &sw_list);
   ...
   * return drv_resp_code_t           - return DRVAPI_RESPONSE_SUCCESS/ DRVAPI_RESPONSE_FAILURE
   */
  drv_resp_code_t parse_node_response(unc::driver::controller *ctr_ptr,
   ...
   */
  drv_resp_code_t delete_logical_port(unc::driver::controller *ctr,
   ...
   *                                   DRVAPI_RESPONSE_FAILURE
   */
  drv_resp_code_t delete_switch(unc::driver::controller *ctr,
                                const std::map<std::string,
                      unc::vtndrvcache::ConfigNode *> &cfg_node_delete_map);
