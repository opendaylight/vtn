...
flowfilterlistUtil::GetValue(json_object *in,action* out) {
  ...
  // Clear memory when variable (dldst_obj) is out of scope
  ...
  // Clear memory when variable (icmptype_obj) is out of scope
...
flowfilterlistUtil::GetValue(json_object *in,flowfilter* out) {
  ...
  // Clear memory when variable (filterType_obj) is out of scope
...
flowfilterlistUtil::GetValue(json_object *in,redirect* out) {
  ...
  // Clear memory when variable (destination_obj) is out of scope
