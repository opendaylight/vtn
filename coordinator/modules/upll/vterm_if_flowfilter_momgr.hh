...
#ifndef MODULES_UPLL_VTERM_IF_FLOWFILTER_MOMGR_HH_
#define MODULES_UPLL_VTERM_IF_FLOWFILTER_MOMGR_HH_
#include <string>
#include <set>
...
/*  This file declares interfaces for keyType KT_VTERMIF_FLOWFILER */
/**
 *  @brief  VtermIfFlowFilterMoMgr class handles all the request
 *          received from service.
 */
class VtermIfFlowFilterMoMgr : public MoMgrImpl {
  private:
    static unc_key_type_t vterm_if_flowfilter_child[];
    /**
     * @brief  Member Variable for VtermIfFlowfilterBindInfo.
     */
    static BindInfo vterm_if_flowfilter_bind_info[];

    /**
     * @brief  Member Variable for VtermIfFlowfilterMainTblBindInfo.
     */
    static BindInfo vterm_if_flowfiltermaintbl_bind_info[];

  public:
    /**
     * @brief  VtermIfFlowFilterMoMgr Class Constructor.
     */
    VtermIfFlowFilterMoMgr();

    /**
     * @brief  VtermIfFlowFilterMoMgr Class Destructor.
     */
    ~VtermIfFlowFilterMoMgr() {
     ...
     *        for KT_VTERMIF_FLOWFILTER keytype
     *
     ...
     * @retval UPLL_RC_ERR_NO_SUCH_INSTANCE  key_vtermif_flowfilter is not available.
     * @retval UPLL_RC_ERR_GENERIC           Generic failure.
     */
    upll_rc_t ValidateMessage(IpcReqRespHeader *req, ConfigKeyVal *key);

    /**
     * @Brief Validates the syntax for KT_VTERMIF_FLOWFILTER keytype key structure.
     *
     * @param[in] key_vtermif_flowfilter KT_VTERMIF_FLOWFILTER key structure.
     *
     * @retval UPLL_RC_SUCCESS        validation succeeded.
     * @retval UPLL_RC_ERR_CFG_SYNTAX validation failed.
     */
    upll_rc_t ValidateVtermIfFlowfilterKey(
          key_vterm_if_flowfilter_t* key_vterm_if_flowfilter,
          unc_keytype_operation_t op);

   /**
    * @Brief Checks if the specified key type(KT_VTERMIF_FLOWFILTER) and
    ...
    */
    ...
    upll_rc_t ReadSiblingDetail(ConfigKeyVal *ikey,
    ...
    upll_rc_t GetVexternalInformation(ConfigKeyVal* ck_main,
                 ...
                 pfcdrv_val_vtermif_vextif *& pfc_val, need to remove
                 uint8_t db_flag, DalDmlIntf *dmi);  // jai
#endif
    upll_rc_t SetPortmapConfiguration(
                                 ConfigKeyVal *ikey,
                                 upll_keytype_datatype_t dt_type,
                                 DalDmlIntf *dmi,
    ...
    upll_rc_t CreateAuditMoImpl(unc::upll::ipc_util::ConfigKeyVal*,
                                unc::upll::dal::DalDmlIntf*, const char*);
...
#endif  // MODULES_UPLL_VTERM_IF_FLOWFILTER_MOMGR_HH_
