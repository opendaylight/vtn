...
#ifndef MODULES_UPLL_VBR_IF_FLOWFILTER_MOMGR_HH_
#define MODULES_UPLL_VBR_IF_FLOWFILTER_MOMGR_HH_
#include <string>
#include <set>
...
class VbrIfFlowFilterMoMgr : public MoMgrImpl {
  private:
     ...
     */
    static BindInfo vbr_if_flowfilter_bind_info[];
  ...
  public:
     ...
     */
    VbrIfFlowFilterMoMgr();

    /**
     * @brief  VbrIfFlowFilterMoMgr Class Destructor.
     */
    ~VbrIfFlowFilterMoMgr() {
     ...
     *        for KT_VBRIF_FLOWFILTER keytype
     *
     ...
     * @retval UPLL_RC_ERR_NO_SUCH_INSTANCE  key_vbrif_flowfilter is not available.
     * @retval UPLL_RC_ERR_GENERIC           Generic failure.
     */
    upll_rc_t ValidateMessage(IpcReqRespHeader *req, ConfigKeyVal *key);

    /**
     * @Brief Validates the syntax for KT_VBRIF_FLOWFILTER keytype key structure.
     *
     * @param[in] key_vbrif_flowfilter KT_VBRIF_FLOWFILTER key structure.
     *
  ...
  upll_rc_t SendInterfaceRequestToDriver(
      ...
      ConfigKeyVal *req, TxUpdateUtil *tx_util);
...
#endif  // MODULES_UPLL_VBR_IF_FLOWFILTER_MOMGR_HH_
