...
/**
 * @brief VtermIfFlowFilterEntryMoMgr class handles all the request
 *  received from service.
 */

enum vtermifFlowfilterEntryMoMgrTables {
  VTERMIFFLOWFILTERENTRYTBL = 0, NVTERMIFFLOWFILTERENTRYTBL
};
class VtermIfFlowFilterEntryMoMgr : public MoMgrImpl {
  private:
    static BindInfo vterm_if_flowfilter_entry_bind_info[];

    /**
     * @brief Member Variable for VbrIfFlowfilterEntryMainTblBindInfo
     */
    static BindInfo vterm_if_flowfilter_entry_main_tbl_bind_info[];
  ...
  public:
    ...
    */
     ...
     *        for KT_VBRIF_FLOWFILTER_ENTRY keytype
     *
     ...
     * @retval UPLL_RC_ERR_NO_SUCH_INSTANCE  key_vbrif_flowfilter_entry is not available.
     * @retval UPLL_RC_ERR_GENERIC           Generic failure.
     */
    ...
    /**
     * @Brief Validates the syntax for KT_VBRIF_FLOWFILTER_ENTRY keytype key structure.
     *
     * @param[in] key_vbrif_flowfilter  KT_VBRIF_FLOWFILTER_ENTRY key structure.
     *
     * @retval UPLL_RC_SUCCESS         validation succeeded.
     * @retval UPLL_RC_ERR_CFG_SYNTAX  validation failed.
     */
    upll_rc_t ValidateVbrIfFlowfilterEntryKey(
           key_vterm_if_flowfilter_entry_t* key_vbr_if_flowfilter_entry,
     ...
     * @param[in]   audit  If true,AuditProcess.
     *
    ...
    upll_rc_t ValidateVtermIfValStruct(
        IpcReqRespHeader *req,
        ConfigKeyVal *ikey);

    upll_rc_t ValidateVtermIfFlowfilterEntryKey(
...
#endif  // MODULES_UPLL_VBR_IF_FLOWFILTER_ENTRY_MOMGR_HH_
