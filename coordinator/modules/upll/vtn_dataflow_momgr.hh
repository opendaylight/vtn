...
class VtnDataflowMoMgr : public MoMgrImpl {
 ...
 private:
   ...
   upll_rc_t UpdateConfigStatus(ConfigKeyVal *ckv1, unc_keytype_operation_t op, uint32_t count, 
                               ConfigKeyVal *ckv2, DalDmlIntf *dmi, ConfigKeyVal *ckv3) {
    UPLL_FUNC_TRACE;
    return UPLL_RC_SUCCESS;
   }
  ...
  upll_rc_t ValidateAttribute(ConfigKeyVal*ikey, DalDmlIntf *dmi, IpcReqRespHeader *header) {
  UPLL_FUNC_TRACE;
  return UPLL_RC_SUCCESS;
  }
  upll_rc_t GetValid(void *v1, uint64_t u, uint8_t*& ui, upll_keytype_datatype_t dt, MoMgrTables tbl) {
  UPLL_FUNC_TRACE;
  return UPLL_RC_SUCCESS;
  }
  upll_rc_t ValidateCapability(IpcReqRespHeader *header, ConfigKeyVal*ikey, const char* ctrkr) {
  UPLL_FUNC_TRACE;
  return UPLL_RC_SUCCESS;
  }
  upll_rc_t DupConfigKeyVal(ConfigKeyVal*&okey, ConfigKeyVal*&ikey, MoMgrTables tbl) {
  UPLL_FUNC_TRACE;
  return UPLL_RC_SUCCESS;
  }
  ...
  upll_rc_t GetRenamedUncKey(ConfigKeyVal* ikey, upll_keytype_datatype_t dt, DalDmlIntf *dmi, uint8_t *ctrlr) {
  UPLL_FUNC_TRACE;
  return UPLL_RC_SUCCESS;
  }
  bool GetRenameKeyBindInfo(unc_key_type_t dt, BindInfo*& binfo, int&count, MoMgrTables tbl) {
  UPLL_FUNC_TRACE;
  return true;
  }
  ...
  upll_rc_t IsReferenced(ConfigKeyVal *ikey, upll_keytype_datatype_t dt, DalDmlIntf *dmi) {
  UPLL_FUNC_TRACE;
  return UPLL_RC_SUCCESS;
  }
  upll_rc_t AllocVal(ConfigVal *&ckv1, upll_keytype_datatype_t dt, MoMgrTables tbl) {
  UPLL_FUNC_TRACE;
  return UPLL_RC_SUCCESS;
  }
