...
#ifndef SRC_MODULES_UPLL_VTERM_IF_POLICINGMAP_MOMGR_HH_
#define SRC_MODULES_UPLL_VTERM_IF_POLICINGMAP_MOMGR_HH_
...
enum vtermifpolicingmapMoMgrTables {
  VTERMIFPOLICINGMAPTBL = 0, NVTERMIFPOLICINGMAPTBL
};
 ...
 **/
class VtermIfPolicingMapMoMgr : public MoMgrImpl {
 private:
  /**
   * Member Variable for PolicingProfileBindInfo.
   * */
  static BindInfo vtermifpolicingmap_bind_info[];
  static BindInfo key_vtermifpm_maintbl_rename_bind_info[];
  static BindInfo key_vtermifpm_policyname_maintbl_rename_bind_info[];
  /**
 ...
 public:
  ...
  upll_rc_t IsKeyInUse(upll_keytype_datatype_t dt_type,
                       ...
                       bool *in_use,
                       DalDmlIntf *dmi);
  upll_rc_t GetReadVtermIfKey(ConfigKeyVal *&dup_key,
                            ConfigKeyVal *ikey);
  ...
  /**
   * @Brief This API is used to update the flag in the Database whenever
   * portmap is configured. The VTermIFMomgr will use this API to Notify
   * VTermIFPolicingMap object to update the  flag whenever PORTMAP is created
   * or deleted.
   *
   * @param[in]    ikey     This Contains the pointer to ConfigKeyVal Object
   * @param[in]    dt_type  Configuration Information.
   * @param[in]    dmi      Pointer to DalDmlIntf Class.
   * @param[in]    flag     Enum containing the information whether the portmap
...
#endif  // SRC_MODULES_UPLL_VTERM_IF_POLICINGMAP_MOMGR_HH_
