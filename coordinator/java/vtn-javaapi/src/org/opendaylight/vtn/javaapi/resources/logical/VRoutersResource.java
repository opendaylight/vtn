 ...
 */
@UNCVtnService(path = "/vtns/{vtn_name}/vrouters")
public class VRoutersResource extends AbstractResource {
	/** The vtn name. */
	@UNCField("vtn_name")
	 ...
	 */
	public VRoutersResource() {
		super();
		LOG.trace("Start VRoutersResource#VRoutersResource()");
	...
	private List<String> getUriParameters(final JsonObject requestBody) {
		LOG.trace("Start VRoutersResource#getUriParameters()");
		...
		LOG.trace("Completed VRoutersResource#getUriParameters()");
