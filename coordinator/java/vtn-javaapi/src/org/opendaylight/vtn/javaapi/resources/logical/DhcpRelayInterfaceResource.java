...
public class DhcpRelayInterfaceResource extends AbstractResource {
	 ...
	 */
	public DhcpRelayInterfaceResource() {
		super();
		LOG.trace("Start DhcpRelayInterfaceResource#DhcpRelayInterfaceResource()");
	...
	public final int delete() throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_DHCPRELAY_IF_DELETE,
	...
	private List<String> getUriParameters() {
		...
		LOG.trace("Completed DhcpRelayInterfaceResource#getUriParameters()");
