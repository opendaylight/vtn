...
/**
 * The Class PortMapResource implements delete, put and get methods.
 * 
 */
...
public class VBridgeInterfacePortMapResource extends AbstractResource {
	...
	public VBridgeInterfacePortMapResource() {
		...
		LOG.trace("Complete PortMapResource#PortMapResource()");
	}

	/**
	 * Implementation of Delete method of PortMap API
	 * 
	 * @return Error code
	...
	public final int delete() throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBR_IF_UPDATE, getNullJsonObject(),
					getUriParameters());
		...
		LOG.trace("Complete PortMapResource#delete()");
		return status;
	}

	/**
	 * Implementation of get method of PortMap API
	 * 
	 * @param requestBody
	...
	public final int get(final JsonObject requestBody)
		...
		LOG.trace("Complete PortMapResource#get()");
		return status;
	}
	...
	public final int put(final JsonObject requestBody)
		...
		LOG.trace("Complete PortMapResource#put()");
		return status;
	}
	...
	private List<String> getUriParameters() {
		LOG.trace("Start PortMapResource#getUriParameters()");
		final List<String> uriParameters = new ArrayList<String>();
		uriParameters.add(vtnName);
		uriParameters.add(vbrName);
		uriParameters.add(ifName);
		LOG.trace("Completed PortMapResource#getUriParameters()");
