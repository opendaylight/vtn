...
public class VBridgesResource extends AbstractResource {
	/** The vtn name. */
	@UNCField("vtn_name")
	private String vtnName;
	/** The LOG. */
	private static final Logger LOG = Logger.getLogger(VBridgesResource.class
			.getName());

	/**
	 * Instantiates a new v bridges resource.
	 */
	public VBridgesResource() {
		super();
		LOG.trace("Start VBridgesResource#VBridgesResource()");
		setValidator(new VBridgeResourceValidator(this));
		LOG.trace("Complete VBridgesResource#VBridgesResource()");
	}
	...
	/**
	 * Implementation of Post method of VBridge API
	 * 
	 * @param requestBody
	...
	public final int post(final JsonObject requestBody)
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBRIDGE_CREATE, requestBody,
		...
		LOG.trace("Complete VBridgesResource#post()");
		return status;
	}
	...
	public final int get(final JsonObject requestBody)
		...
		LOG.trace("Complete VBridgesResource#get()");
		return status;
	}
