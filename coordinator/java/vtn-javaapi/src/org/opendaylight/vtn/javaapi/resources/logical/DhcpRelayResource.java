...
import org.opendaylight.vtn.javaapi.validation.logical.DhcpRelayResourceValidator;

/**
 * The Class DhcpRelayResource implements put and get methods.
 */
@UNCVtnService(path = "/vtns/{vtn_name}/vrouters/{vrt_name}/dhcprelay")
public class DhcpRelayResource extends AbstractResource {
	/** The vtn name. */
	@UNCField("vtn_name")
	 ...
	 */
	public DhcpRelayResource() {
		super();
		LOG.trace("Start DhcpRelayResource#DhcpRelayResource()");
	...
	private List<String> getUriParameters() {
		...
		LOG.trace("Completed DhcpRelayResource#getUriParameters()");
