...
/**
 * The Class VBridgeFlowFilterEntryResource implements delete ,put and get
 * methods.
 * 
 */
...
public class VBridgeFlowFilterEntryResource extends AbstractResource {
	...
	private static final Logger LOG = Logger
			.getLogger(VBridgeFlowFilterEntryResource.class.getName());

	/**
	 * Instantiates a new v bridge flow filter entry resource.
	 */
	public VBridgeFlowFilterEntryResource() {
		super();
		LOG.trace("Start VBridgeFlowFilterEntryResource#VBridgeFlowFilterEntryResource()");
		setValidator(new VBridgeFlowFilterEntryResourceValidator(this));
		LOG.trace("Complete VBridgeFlowFilterEntryResource#VBridgeFlowFilterEntryResource()");
	}
	...
	/**
	 * Implementation of Delete method of VBridgeFlowFilterEntry API
	 * 
	 * @return Error code
	...
	public final int delete() throws VtnServiceException {
		...
		LOG.trace("Complete VBridgeFlowFilterEntryResource#delete()");
		return status;
	}

	/**
	 * Implementation of Put method of VBridgeFlowFilterEntry API
	 * 
	 * @param requestBody
	...
	public final int put(final JsonObject requestBody)
		...
		try {
			...
			requestProcessor = new IpcRequestProcessor(session, getSessionID(),
					getConfigID(), getExceptionHandler());
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBR_FLOWFILTER_ENTRY_UPDATE,
		...
		LOG.trace("Complete VBridgeFlowFilterEntryResource#put()");
		return status;
	}

	/**
	 * Implementation of Get method of VBridgeFlowFilterEntry API
	 * 
	 * @param requestBody
	 *            the request Json object
	 * 
	...
	public final int get(final JsonObject requestBody)
		...
		LOG.trace("Complete VBridgeFlowFilterEntryResource#get()");
		return status;
	}
	...
	private List<String> getUriParameters() {
		LOG.trace("Start VBridgeFlowFilterEntryResource#getUriParameters()");
		final List<String> uriParameters = new ArrayList<String>();
		uriParameters.add(vtnName);
		uriParameters.add(vbrName);
		uriParameters.add(ffType);
		uriParameters.add(seqnum);
		LOG.trace("Completed VBridgeFlowFilterEntryResource#getUriParameters()");
