...
/**
 * The Class VtnsResource implements post and get methods.
 */
@UNCVtnService(path = "/vtns")
public class VtnsResource extends AbstractResource {
	/** The Constant LOG. */
	 ...
	 */
	public VtnsResource() {
		LOG.trace("Start VtnsResource#VtnsResource()");
	...
	public int post(final JsonObject requestBody) throws VtnServiceException {
		LOG.trace("Start VtnsResource#put()");
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VTN_CREATE, requestBody,
					getNullListObject());
	...
	public int get(final JsonObject requestBody) throws VtnServiceException {
		LOG.trace("Start VtnsResource#get()");
		ClientSession session = null;
		IpcRequestProcessor requestProcessor = null;
		int status = ClientSession.RESP_FATAL;
		try {
	...
	private List<String> getUriParameters(final JsonObject requestBody) {
		LOG.trace("Start VtnsResource#getUriParameters()");
