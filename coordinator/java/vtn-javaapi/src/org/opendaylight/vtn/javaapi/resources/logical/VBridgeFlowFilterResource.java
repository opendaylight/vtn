...
public class VBridgeFlowFilterResource extends AbstractResource {
	...
	private static final Logger LOG = Logger
			.getLogger(VBridgeFlowFilterResource.class.getName());

	/**
	 * Instantiates a new vbridge flow filter resource.
	 */
	public VBridgeFlowFilterResource() {
		super();
		LOG.trace("Start VBridgeFlowFilterResource#VBridgeFlowFilterResource()");
		setValidator(new FlowFilterResourceValidator(this));
		LOG.trace("Complete VBridgeFlowFilterResource#VBridgeFlowFilterResource()");
	}
	...
	/**
	 * Implementation of Delete method of VBridgeFlowFilter API
	 * 
	 * 
	 * @return Error code
	...
	public final int delete() throws VtnServiceException {
		...
		LOG.trace("Complete VBridgeFlowFilterResource#delete()");
		return status;
	}

	/**
	 * Implementation of Get method of VBridgeFlowFilter API
	 * 
	 * @param requestBody
	...
	public final int get(final JsonObject requestBody)
		...
		try {
			...
			requestProcessor = new IpcRequestProcessor(session, getSessionID(),
					getConfigID(), getExceptionHandler());
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBR_FLOWFILTER_GET, requestBody,
					getUriParameters());
			LOG.debug("Request Packet created successfully");
			status = requestProcessor.processIpcRequest();
			LOG.debug("Request packet processed with status" + status);
			final IpcLogicalResponseFactory responseGenerator = new IpcLogicalResponseFactory();
			setInfo(responseGenerator.getVBridgeFlowFilterResourceResponse(
		...
		LOG.trace("Complete VBridgeFlowFilterResource#get()");
		return status;
	}
	...
	private List<String> getUriParameters() {
		LOG.trace("Start VBridgeFlowFilterResource#getUriParameters()");
		final List<String> uriParameters = new ArrayList<String>();
		uriParameters.add(vtnName);
		uriParameters.add(vbrName);
		uriParameters.add(ffType);
		LOG.trace("Completed VBridgeFlowFilterResource#getUriParameters()");
