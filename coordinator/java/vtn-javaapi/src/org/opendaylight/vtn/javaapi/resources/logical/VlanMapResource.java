...
public class VlanMapResource extends AbstractResource {
	...
	/** The LOG. */
	private static final Logger LOG = Logger.getLogger(VlanMapResource.class
			.getName());
	...
	/**
	 * Instantiates a new vlan map resource.
	 */
	public VlanMapResource() {
		super();
		LOG.trace("Start VlanMapResource#VlanMapResource()");
		setValidator(new VLanMapResourceValidator(this));
		LOG.trace("Complete VlanMapResource#VlanMapResource()");
	}

	/**
	 * Implementation of Delete method of Vlanmap API
	 * 
	 * @return Error code
	...
	public int delete() throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBR_VLANMAP_DELETE,
		...
		LOG.trace("Complete VlanMapResource#delete()");
		return status;
	}

	/**
	 * Implementation of Put method of Vlanmap API
	 * 
	 * @param requestBody
	...
	public int put(final JsonObject requestBody) throws VtnServiceException {
		...
		try {
			...
			requestProcessor = new IpcRequestProcessor(session, getSessionID(),
					getConfigID(), getExceptionHandler());
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_VBR_VLANMAP_UPDATE, requestBody,
					getUriParameters());
			LOG.debug("Request Packet created successfully");
			status = requestProcessor.processIpcRequest();
			LOG.debug("Request packet processed with status" + status);
		...
		LOG.trace("Complete VlanMapResource#put");
		return status;
	}
	...
	public int get(final JsonObject requestBody) throws VtnServiceException {
		...
		LOG.trace("Complete VlanMapResource#get()");
		return status;
	}
	...
	private List<String> getUriParameters() {
		LOG.trace("Start VlanMapResource#getUriParameters()");
		final List<String> uriParameters = new ArrayList<String>();
		uriParameters.add(vtnName);
		uriParameters.add(vbrName);
		uriParameters.add(vlanMapId);
		LOG.trace("Completed VlanMapResource#getUriParameters()");
