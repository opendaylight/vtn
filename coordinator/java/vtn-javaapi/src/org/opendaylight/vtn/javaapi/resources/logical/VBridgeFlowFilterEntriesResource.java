...
public class VBridgeFlowFilterEntriesResource extends AbstractResource {
	...
	private static final Logger LOG = Logger
			.getLogger(VBridgeFlowFilterEntriesResource.class.getName());

	/**
	 * Instantiates a new v bridge flow filter entries resource.
	 */
	public VBridgeFlowFilterEntriesResource() {
		super();
		LOG.trace("Start VBridgeFlowFilterEntriesResource#VBridgeFlowFilterEntriesResource()");
		setValidator(new VBridgeFlowFilterEntriesResourceValidator(this));
		LOG.trace("Complete VBridgeFlowFilterEntriesResource#VBridgeFlowFilterEntriesResource()");
	}
	...
	/**
	 * Implementation of Post method of VBridgeFlowFilterEntries API
	 * 
	 * @param requestBody
	...
	public int post(final JsonObject requestBody) throws VtnServiceException {
		...
		LOG.trace("Complete VBridgeFlowFilterEntriesResource#post()");
		return status;
	}

	/**
	 * Implementation of Get method of VBridgeFlowFilterEntries API
	 * 
	 * @param requestBody
	 *            the request Json object
	 * 
	...
	public int get(final JsonObject requestBody) throws VtnServiceException {
		...
		LOG.trace("Complete VBridgeFlowFilterEntriesResource#get()");
		return status;
	}
	...
	private List<String> getUriParameters(final JsonObject requestBody) {
		LOG.trace("Start VBridgeFlowFilterEntriesResource#getUriParameters()");
		...
		LOG.trace("Completed VBridgeFlowFilterEntriesResource#getUriParameters()");
