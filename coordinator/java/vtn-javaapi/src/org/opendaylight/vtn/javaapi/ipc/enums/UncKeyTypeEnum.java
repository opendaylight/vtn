...
public enum UncKeyTypeEnum {
	...
	//
	 UNC_KT_VTERMINAL(0x021),
     UNC_KT_VTERM_IF(0x022),
     UNC_KT_VTERMIF_POLICINGMAP(0x023),
     UNC_KT_VTERMIF_POLICINGMAP_ENTRY(0x024),
     UNC_KT_VTERMIF_FLOWFILTER(0x025),
     UNC_KT_VTERMIF_FLOWFILTER_ENTRY(0x026),

	UNC_KT_VUNKNOWN(0x027),
	UNC_KT_VUNK_IF(0x028),
	UNC_KT_VTEP(0x029),
	UNC_KT_VTEP_IF(0x02a),
	UNC_KT_VTEP_GRP(0x02b),
	UNC_KT_VTEP_GRP_MEMBER(0x02c),
	UNC_KT_VTUNNEL(0x02d),
	UNC_KT_VTUNNEL_IF(0x02e),
	UNC_KT_VLINK(0x02f),
	UNC_KT_VTN_POLICINGMAP(0x030),
	UNC_KT_VTN_POLICINGMAP_CONTROLLER(0x031),
	UNC_KT_VTN_FLOWFILTER(0x032),
	UNC_KT_VTN_FLOWFILTER_ENTRY(0x033),
	UNC_KT_VTN_FLOWFILTER_CONTROLLER(0x034),
	UNC_KT_VTN_PATHMAP_ENTRY(0x035),
	UNC_KT_VTN_PATHMAP_CONTROLLER(0x036),
	UNC_KT_VTN_DATAFLOW(0x037),
	...
	UNC_KT_CTR_PATH_POLICY(0x20a),
	UNC_KT_CTR_PPOLICY_LINK_WEIGHT(0x20b),
	UNC_KT_CTR_PPOLICY_DISABLE_SWITCH(0x20c),
	UNC_KT_VTN_PATH_MAP_ENTRY(0x20d),
	UNC_KT_VTN_PATH_MAP_PPOLICY_ENTRY(0x20e),
	UNC_KT_VTN_PATH_MAP(0x20f);
