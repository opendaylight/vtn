...
@UNCVtnService(path = "/controllers/{controller_id}")
public class ControllerResource extends AbstractResource {
	private static final Logger LOG = Logger.getLogger(ControllerResource.class
			.getName());
	...
	public ControllerResource() {
		super();
		LOG.trace("Start ControllerResource#ControllesrResource()");
		setValidator(new ControllerResourceValidator(this));
		LOG.trace("Completed ControllerResource#ControllesrResource()");
	}
	...
	/**
	 * Implementation of Put method of Controller API
	 * 
	 * @param requestBody
	...
	public int put(final JsonObject requestBody) throws VtnServiceException {
		...
		try {
			...
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_CONTROLLER_UPDATE, requestBody,
					getUriParameters());
		...
		LOG.trace("Completed ControllerResource#put()");
		return status;
	}

	/**
	 * Implementation of Delete method of Controller API
	 * 
	 * @return Error code
	 * @throws VtnServiceException
	 */
	...
	public int delete() throws VtnServiceException {
		...
		try {
			...
			requestProcessor = new IpcRequestProcessor(session, getSessionID(),
					getConfigID(), getExceptionHandler());
			requestProcessor.createIpcRequestPacket(
					IpcRequestPacketEnum.KT_CONTROLLER_DELETE,
		...
		LOG.trace("Completed ControllerResource#delete()");
		return status;
	}
	...
	public int get(final JsonObject requestBody) throws VtnServiceException {
		...
		LOG.trace("Completed ControllerResource#get()");
		return status;
	}
	...
	private List<String> getUriParameters() {
		LOG.trace("Starts ControllerResource#getUriParameters()");
		final List<String> uriParameters = new ArrayList<String>();
		uriParameters.add(controllerId);
		LOG.trace("Completed ControllerResource#getUriParameters()");
