...
/**
 * <p>
 *   The {@code IpcInt8} is an IPC additional data unit class which
 *   represents a signed 8-bit integer value.
 * </p>
 *
 * @since	C10
 */
public final class IpcInt8 extends IpcNumber implements Comparable<IpcInt8>
{
	/**
	 * The signed 8-bit value.
	 */
	private final byte  _value;

	/**
	 * Construct a signed 8-bit data.
	 *
	 * @param value		A value for a new object.
	 */
	public IpcInt8(byte value)
	{
		_value = value;
	}
	...
	/**
	 * <p>
	 *   Construct a new signed 8-bit data indicated by the specified
	 *   string.
	 * </p>
	 * <p>
	 *   This method uses {@link Byte#decode(String)} to parse the
	 *   specified string.
	 * </p>
	 *
	 ...
	 */
	public IpcInt8(String str)
	{
		Byte b = Byte.decode(str);
		_value = b.byteValue();
	}
	 ...
	 *
	 * @return	{@link IpcDataUnit#INT8} is always returned.
	 */
	@Override
	public int getType()
	{
	...
	{
		if (obj instanceof IpcInt8) {
			return (_value == ((IpcInt8)obj)._value);
		}
	...
	/**
	 * Compare this object to the specified {@code IpcInt8} object.
	 *
	 * @param obj	An {@code IpcInt8} object to be compared.
	 ...
	 */
	@Override
	public int compareTo(IpcInt8 obj)
	{
	...
	{
		target.setByte(name, -1, INT8, _value);
	}
	...
	{
		target.setByte(name, index, INT8, _value);
	}
