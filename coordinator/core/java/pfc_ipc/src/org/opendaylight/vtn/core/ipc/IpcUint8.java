...
/**
 * <p>
 *   The {@code IpcUint8} is an IPC additional data unit class which
 *   represents an unsigned 8-bit integer value.
 * </p>
 *
 * @since	C10
 */
public final class IpcUint8 extends IpcNumber implements Comparable<IpcUint8>
{
	/**
	...
	/**
	 * Construct an unsigned 8-bit data from the specified {@code byte}
	 * value.
	 * The specified value is treated as unsigned integer.
	 *
	 * @param value		A value for a new object.
	 */
	public IpcUint8(byte value)
	{
		_value = UnsignedInteger.shortValue(value);
	}

	/**
	 * <p>
	 *   Construct an unsigned 8-bit data from the specified {@code int}
	 *   value.
	 * </p>
	 * <p>
	 *   Note that the specified value must be in valid range of
	 *   unsigned 8-bit integer. That is, it must be greater than or
	...
	/**
	 * <p>
	 *   Construct a new unsigned 8-bit data indicated by the specified
	 *   string.
	 * </p>
	 * <p>
	 *   This method uses {@link UnsignedInteger#parseByte(String)}
	 ...
	 * @see	UnsignedInteger#parseByte(String)
	 */
	public IpcUint8(String str)
	{
		byte b = UnsignedInteger.parseByte(str);
		_value = UnsignedInteger.shortValue(b);
	 ...
	 *
	 * @return	{@link IpcDataUnit#UINT8} is always returned.
	 */
	@Override
	public int getType()
	{
	...
	{
		if (obj instanceof IpcUint8) {
			return (_value == ((IpcUint8)obj)._value);
		}
	...
	/**
	 * Compare this object to the specified {@code IpcUint8} object.
	 *
	 * @param obj	An {@code IpcUint8} object to be compared.
	 ...
	 */
	@Override
	public int compareTo(IpcUint8 obj)
	{
	...
	{
		addClientOutput(session, (byte)_value);
	}
	...
	{
		target.setByte(name, -1, UINT8, (byte)_value);
	}
	...
	{
		target.setByte(name, index, UINT8, (byte)_value);
	}
